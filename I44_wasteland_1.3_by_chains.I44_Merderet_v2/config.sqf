...
cityList = [
		["Town_0",300,"Chef-Du-Pont"],
		["Town_1",100,"Mill"],
		["Town_2",100,"Eastern Roads"],
		["Town_3",200,"Castle"],
		["Town_4",200,"Chateau de Guy-son"],
		["Town_5",200,"St Mer Pacese"],
		["Town_6",100,"Army Camp"],
		["Town_7",200,"Esefge-s"],
		["Town_8",200,"St Vexage"],
		["Town_9",100,"Western Farms"],
		["Town_10",100,"Factory"],
		["Town_11",200,"Northern Town"],
		["Town_12",200,"Chateau de Bosson"],
		["Town_13",200,"Small Town West"]
];
cityLocations = [];
